...
* **Linguagem Principal:** C++ (focada em performance e execução eficiente)
* **Tópicos e Conceitos Praticados:**
  * Algoritmos de Busca e Ordenação
  * Estruturas de Dados Avançadas (Grafos, Árvores, Stacks, Queues)
  * Programação Dinâmica (DP) e Algoritmos Ambiciosos (*Greedy*)
  * Teoria dos Números e Matemática Computacional
